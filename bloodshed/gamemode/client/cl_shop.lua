...
concommand.Add("mur_shop", function()
    ...
    if MuR.GamemodeCount == 50 or MuR.GamemodeCount == 51 or MuR.GamemodeCount == 53 or MuR.GamemodeCount == 54 or MuR.GamemodeCount == 55 or MuR.GamemodeCount == 56 then return end
    OpenShop()
end)
