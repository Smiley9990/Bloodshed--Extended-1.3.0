...
function meta:BuyItem(cat, id)
	...
	if class == "Maniac" or class == "Tagila" then return end
	...
	if MuR.Gamemode == 50 or MuR.Gamemode == 51 or MuR.Gamemode == 53 or MuR.Gamemode == 54 or MuR.Gamemode == 55 or MuR.Gamemode == 56 then
		MuR:GiveAnnounce("shop_disabled_mode50", self)
		return
	end
