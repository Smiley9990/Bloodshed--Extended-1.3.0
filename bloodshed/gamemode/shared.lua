...
MuR.shared("shared/sh_fury13_move.lua")
...
MuR.server("server/sv_spawn_debug.lua")
...
MuR.server("server/sv_fury13_damage.lua")
...
MuR.client("client/cl_ragdoll_breath.lua")
...
MuR.client("client/cl_mode52.lua")
MuR.client("client/cl_mode53.lua")
MuR.client("client/cl_mode54.lua")
MuR.client("client/cl_mode54_class_select.lua")
MuR.client("client/cl_mode56_masska_message.lua")
...
MuR.client("client/cl_armor_debug.lua")
MuR.client("client/cl_spawn_debug.lua")
MuR.client("client/cl_armor_ears.lua")
MuR.client("client/cl_nzdeath.lua")
MuR.client("client/cl_fury13_effects.lua")
...
MuR.Shop = {
	...
	["Killer"] = {
		...
		},
		{
			...
			traitor = true,
			func = function(ply)
				ply:GiveWeapon("mur_cyanide_sneeze")
			end,
		},
		{
			name = "Traitor Syringe",
			icon = "entities/mur_cyanide.png",
			price = 100,
			traitor = true,
			func = function(ply)
				ply:GiveWeapon("mur_traitor_syringe")
			end,
		},
		{
...
MuR.Loot = {
	...
	{
		class = "mur_armor_helmet_tsh4m",
		chance = 6
	},
	{
		class = "mur_armor_helmet_k1c",
		chance = 4
	},
	{
		class = "mur_armor_helmet_shpm",
		chance = 4
	},
	{
		class = "mur_armor_cap_bear_black",
		chance = 12
	},
	{
		class = "mur_armor_cap_bear_green",
		chance = 12
	},
	{
		class = "mur_armor_cap_boss",
		chance = 12
	},
	{
		class = "mur_armor_cap_mhs",
		chance = 12
	},
	{
		class = "mur_armor_cap_police",
		chance = 12
	},
	{
		class = "mur_armor_cap_scav",
		chance = 12
	},
	{
		class = "mur_armor_facecover_skull",
		chance = 12
	},
	{
		class = "mur_armor_facecover_gray",
		chance = 12
	},
	{
		class = "mur_armor_facecover_black",
		chance = 12
	},
	{
		class = "mur_armor_facecover_smoke",
		chance = 12
	},
	{
		class = "mur_armor_face_aviator",
		chance = 12
	},
	{
		class = "mur_armor_face_gaswelder",
		chance = 12
	},
	{
		class = "mur_armor_face_tactical",
		chance = 12
	},
	{
		class = "mur_armor_face_raybench",
		chance = 12
	},
	{
		class = "mur_armor_face_roundglasses",
		chance = 12
	},
	{
		class = "mur_armor_face2_jason",
		chance = 8
	},
	{
		class = "mur_armor_face2_halfmask_skull",
		chance = 8
	},
	{
		class = "mur_armor_face2_welding_ubey",
		chance = 1
	},
	{
		class = "mur_armor_face2_deadlyskull",
		chance = 2
	},
	{
		class = "mur_armor_vest_security",
		chance = 6
	},
	{
		class = "mur_armor_vest_hexgrid",
		chance = 1
	},
	{
		class = "mur_armor_vest_hexatac",
		chance = 2
	},
	{
		class = "mur_armor_vest_korakulon_black",
		chance = 3
	},
	{
		class = "mur_armor_vest_korakulon_emr",
		chance = 3
	},
	{
		class = "mur_armor_vest_fishing",
		chance = 12
	},
	{
		class = "mur_armor_vest_zhuk_press",
		chance = 1
	},
	{
		class = "mur_loot_fentanyl",
		chance = 10
	},
	{
		class = "mur_meth",
...
MuR.CustomLootEntityIcons = {
	...
	["mur_armor_facecover_nomex"] = {"Tactical Nomex Balaclava", "entities/mur_armor_facecover_nomex.png"},
	["mur_armor_facecover_skull"] = {"Skull Balaclava", "entities/ent_jack_gmod_ezarmor_ghostbalacvlava.png"},
	["mur_armor_facecover_gray"] = {"Gray Balaclava", "entities/ent_jack_gmod_ezarmor_balaclava.png"},
	["mur_armor_facecover_black"] = {"Black Balaclava", "entities/ent_jack_gmod_ezarmor_balaclavablack.png"},
	["mur_armor_facecover_smoke"] = {"Smoke Balaclava", "entities/ent_jack_gmod_ezarmor_smokebalacvlava.png"},
	["mur_armor_facecover_zryachii"] = {"Zryachii Balaclava", "entities/ent_jack_gmod_ezarmor_zryachiibalacvlava.png"},
	["mur_armor_facecover_hockey_captain"] = {"Hockey Captain Mask", "entities/ent_jack_gmod_ezarmor_hockeycaptain.png"},
	["mur_armor_facecover_hockey_brawler"] = {"Hockey Brawler Mask", "entities/ent_jack_gmod_ezarmor_hockeybrawler.png"},
	["mur_armor_facecover_hockey_quiet"] = {"Hockey Quiet Mask", "entities/ent_jack_gmod_ezarmor_hockeyquiet.png"},
	["mur_armor_cap_bear_black"] = {"Black Cap", "entities/ent_jack_gmod_ezarmor_bearcapblack.png"},
	["mur_armor_cap_bear_green"] = {"Green Cap", "entities/ent_jack_gmod_ezarmor_bearcapgreen.png"},
}
