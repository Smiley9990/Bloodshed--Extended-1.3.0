        ...
        if self.Activated then
            ...
            if CurTime() > self.NextGasEmit then
                ...
                if IsValid(smoke) then
                    ...
                    smoke:SetKeyValue("startcolor", "200 200 255")
                    smoke:SetKeyValue("endcolor", "200 200 255")
                ...
                for _, ply in player.Iterator() do
                    if ply:GetPos():Distance(pos) < 300 then
                        if ply:Alive() then
                            MuR.SubstanceSystem:ApplyPoisonFromCloud(ply, "cyanide", owner, 1)
                        end
                    end
                end
            end
