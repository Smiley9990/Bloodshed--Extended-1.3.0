...
SWEP.PrintName = "F1"
SWEP.Slot = 4
SWEP.WorldModel = "models/simpnades/w_f1.mdl"
SWEP.ViewModel = "models/simpnades/v_f1.mdl"
...
if CLIENT then
	...
	local grenade_model = ClientsideModel("models/simpnades/w_f1.mdl")
	grenade_model:SetNoDraw(true)
	
	hook.Add("PostDrawTranslucentRenderables", "DrawTripwirePreviewf1", function()
		local wep = LocalPlayer():GetActiveWeapon()
		if not IsValid(wep) or wep:GetClass() ~= "mur_f1" then return end
